        ...
        fetchNotificationListWithFiltersData(
            ...
            .then((res) => {
                res.forEach((d) => {
                    ...
                    if (d.activity === "POST_OWNERSHIP") {
                        d.activity = "assigned owner"
                    }
