...
import { fillSelectWithAPIResponse } from "../../../util";

const selectOptions = fillSelectWithAPIResponse(JSON.stringify(localStorage.getItem("TAGS")));
const sizes = { sm: "p-[2px]", md: "pt-[3px]" };

const SelectBox1 = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
